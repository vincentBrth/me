...
<?php
	$nb_values=get_nb_line_all();
	echo '<p><strong>' . $nb_values . '</strong> entries have already be registered in the Database</p><br/>';	
?>	
	<p><a href='addValue.php' title='Add a new value in a tab '>Add a new value	in a table</a></p>
	<p><a href='updateValue.php' title='Update a value in a tab '>Update a value in a table</a></p>
	<p><a href='deleteValue.php' title='delete a value in a tab '>Delete a value in a table</a></p><br/>
<?php
	get_table(1,'Battery 1','ID','Voltage (V)','Charge (%)','Date','State'); 
	get_table(2,'Battery 2','ID','Voltage (V)','Charge(%)','Date','State');
	get_table(3,'Battery 3','ID','Voltage (V)','Charge (%)','Date','State'); 

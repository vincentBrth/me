<?php
	...
	$request = $db->query("SELECT MIN(date_mesure) FROM batteries WHERE batterie=4");
	$data = $request->fetch();
	$request->closeCursor();
	...
	if($data[0]==NULL)
	{
		echo '<center>The chart can\'t be display, there is no data for \'Battery 4\'</center><br/><br/>';
	}
	else
	{
...
$(function () {
  ...
  // $.getJSON('dataBattery1.php', function (data) {
   $.getJSON('script/chart/dataBattery4.php', function (data) {
        // Create the chart

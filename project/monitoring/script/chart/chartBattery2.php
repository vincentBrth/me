<?php
	...
	$request = $db->query("SELECT MIN(date_mesure) FROM batteries WHERE batterie=2");
	$data = $request->fetch();
	$request->closeCursor();
	...
	if($data[0]==NULL)
	{
		echo '<center>The chart can\'t be display, there is no data for \'Battery 2\'</center><br/><br/>';
	}
	else
	{
...
$(function () {
   ...
   $.getJSON('script/chart/dataBattery2.php', function (data) {
        // Create the chart

...
<!-- /////////////////////////////////////////////////////////////////DEBUT MODIFICATIION DE LA PAGE ///////////////////////////////////////////////////////////////////////-->
			...
			<p><em><u>Care :</u></em>  The Data will be removed</p>

		
		<form action='script/deleteValue_post.php' style="margin-top:5%" method='POST'>
			<center>	
				<p><label style="margin-right:15px" for='id'>ID   <input style="margin-left:10px" type='text' name='id' id='id' /></label></p>
				<br/>				
				<button tabindex="3" type="submit" class="btn btn-remove">Remove from DataBase</button>
			</center>				
		</form>
...
<?php
		...
		if(isset($_GET['report']))
		{
			...
			{
				case 0:
					echo '<strong><span style="color:green;">Sucess</span> Value delete in the DataBase</strong>';
				break;
